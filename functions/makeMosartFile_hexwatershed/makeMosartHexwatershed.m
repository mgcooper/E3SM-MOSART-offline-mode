function makeMosartHexwatershed(fhex,ftem,fmos,varargin)
   ...
   addRequired(parser, 'fhex', @ischarlike);
   addRequired(parser, 'ftem', @ischarlike);
   addRequired(parser, 'fmos', @ischarlike);
   addParameter(parser, 'fdom', '', @ischarlike);
   addParameter(parser, 'add_ele', false, @islogical);
   addParameter(parser, 'plot_river', false, @islogical);
   addParameter(parser, 'plot_mesh', false, @islogical);
   parse(parser,fhex,ftem,fmos,varargin{:});

   fdom = parser.Results.fdom;
   add_ele = parser.Results.add_ele;
   plot_mesh = parser.Results.plot_mesh;
   plot_river = parser.Results.plot_river;
