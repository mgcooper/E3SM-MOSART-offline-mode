function makeMosartHexwatershed(fhex,ftem,fmos,fdom,show_river,show_attributes)
%MAKEMOSARTHEXWATERSHED general description of function
% 
% Syntax:
% 
%  [Z,R] = MAKEMOSARTHEXWATERSHED(x);
%  [Z,R] = MAKEMOSARTHEXWATERSHED(x,'name1',value1);
%  [Z,R] = MAKEMOSARTHEXWATERSHED(x,'name1',value1,'name2',value2);
%  [Z,R] = MAKEMOSARTHEXWATERSHED(___,method). Options: 'flag1','flag2','flag3'.
...
% mgc: this file was emailed to me from donghui. I modified it.
