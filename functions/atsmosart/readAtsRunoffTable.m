...
% probably makes sense to have this read the spreadhseet and the area file and
% require hs_id and use it as a preprocessor for mk_runoff
...
% the first three columns are year, doy, day since first day. remove them, build
% a calendar, and convert to timetable: Time = datetime(T(:,1)+T(:,2)./365)
...
% % for reference, an earlier version had slopes numbered from 1:36:
% for n = 1:nslopes    
