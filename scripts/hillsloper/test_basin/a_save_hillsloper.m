...
plot_map    = true;
plot_geo    = false;
p.data      = ['/Users/coop558/mydata/interface/sag_basin/hillsloper/' ...
            'test_huc12/hillsloper-master-4/Data/huc_190604020404/akalbers/'];
p.save      = setpath('interface/data/sag/hillsloper/test_basin/newslopes/');
...
links       = shaperead([p.data list(2).name]); % new sf w/hs_id
nodes       = shaperead([p.data list(3).name]);
...
fname       = [p.data 'huc_190604020404.tif'];
