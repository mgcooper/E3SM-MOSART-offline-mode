...
% 20 March 2023 - where to pick up. 

% TLDR: pick back up when Jon provides the new hillsloper output, if it icnludes
% the elevation and slope of the hillslopes then I won't need to compute them,
% then finish siimplfiying b_make_newlslopes and add c_write_slopes_shapefile to
% the end of b_make_newslopes, eliminate a_save_hillsloper with
% readHilllsloperData and a function that does the merging of the slopes and the
% various geospatial processing at the bottom of this script

% - a_save_hillsloper should be eliminated, use readHillsloperData instead
% - a_save_hillsloper computes the area, elevation, and slope of the split
% hillslopes, need to make a function that does that in b_make_newslopes in the
% loop after the two slopes are merged, using the GRD, DEM stuff from here
% - alternatively, use fields rpovided in the new hillsloper output
% - 


% initial save of hillsloper data to get it into a useable form, converted to
% mosart form in b_make_newslopes
